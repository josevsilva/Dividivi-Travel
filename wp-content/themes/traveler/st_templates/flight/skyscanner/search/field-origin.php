...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <div class="st-select-wrapper ss-flight-wrapper" >
        <input <?php echo esc_html($is_required); ?> id="ss_location_origin" type="text" class="form-control ss-flight-location" autocomplete="off" data-value=""  value="" placeholder="<?php echo esc_html( $placeholder ); ?>">
    </div>
</div>