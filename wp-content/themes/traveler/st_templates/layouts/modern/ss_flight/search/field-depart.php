...
<div data-tp-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange  form-group-lg form-group-icon-left st_left">
    ...
    <input  placeholder="<?php echo esc_attr(TravelHelper::getDateFormatJs()); ?>" class="form-control tp_depart_date required" readonly value="" type="text"     style="text-align: center;" />
