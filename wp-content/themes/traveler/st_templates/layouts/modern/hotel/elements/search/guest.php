        ...
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" id="room_num_search" name="room_num_search" value="<?php echo esc_attr($room_num_search); ?>" class="form-control st-input-number" autocomplete="off" readonly data-min="1" data-max="20"/>
                </div>
            </div>
        </li>
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" id="adult_number" name="adult_number" value="<?php echo esc_attr($adult_number); ?>" class="form-control st-input-number" autocomplete="off" readonly data-min="1" data-max="20"/>
                </div>
            </div>
        </li>
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" id="child_number" name="child_number" value="<?php echo esc_attr($child_number); ?>" class="form-control st-input-number" autocomplete="off" readonly data-min="0" data-max="20"/>
                </div>
            </div>
        </li>
