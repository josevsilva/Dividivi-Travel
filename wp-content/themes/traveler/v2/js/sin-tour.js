...
function form_package_extra( event ) {
    var target = $( event.target );
    if (!target.closest("#dropdown-more-extra").length) {
        $('ul#dropdown-more-extra').removeClass("dropdown-menu extras collapse in");
        $('ul#dropdown-more-extra').addClass("dropdown-menu extras collapse");
        $('ul#dropdown-more-extra').attr("aria-expanded",false);
    }
}
jQuery( "body" ).click( form_package_extra );