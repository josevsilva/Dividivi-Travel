...
$newDate = date("Ymd", strtotime($check_in));
$newDate2 = date("Ymd", strtotime($check_out)); 
?>
<style>
...
<html lang="en-US">
    <head>
        ...
        <link rel="pingback" href="https://dividivitravel.com/xmlrpc.php">
                <title>Search Hotel &#8211; WP-CLI</title>
...
<div class="banner st_1616163085 ">
    ...
    <label>Destination</label>
        <div class="render">
                        <input type="text" touchend="stKeyupsmartSearch(this)" autocomplete = "off" onkeyup="stKeyupsmartSearch(this.value)" id="location_name" name="location_name" placeholder = "Where are you going?" />
        </div>
        
       <input type="hidden" id="location_id" name="location_id"/>
    </div>
</div><div class="item" id="destinationn"></div>
                </div>
    ...
    <input type="text" class="check-in-out" value="19/03/2021 02:11 pm-20/03/2021 02:11 pm" name="date">
</div>                </div>
        ...
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" id="room_num_search" name="room_num_search" value="1" class="form-control st-input-number" autocomplete="off" readonly data-min="1" data-max="20"/>
                </div>
            </div>
        </li>
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" id="adult_number" name="adult_number" value="1" class="form-control st-input-number" autocomplete="off" readonly data-min="1" data-max="20"/>
                </div>
            </div>
        </li>
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" id="child_number" name="child_number" value="0" class="form-control st-input-number" autocomplete="off" readonly data-min="0" data-max="20"/>
                </div>
            </div>
        </li>
    ...
    <div class="item-content">
        <input type="text" class="price_range" name="price_range" value="0;350" data-symbol="€" data-min="0" data-max="350" data-step="0"/>
    ...
    <g id="Ico_close" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
        ...
        <h3 class="search-string modern-result-string" id="modern-result-string"><?php echo sizeof($hotels)." Hotels Found"; ?><div id="btn-clear-filter" class="btn-clear-filter" style="display: none">Clear filter</div> </h3>
</div>
   ...
   <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 item-service grid-item has-matchHeight">
    ...
    <div class="section-footer">
        <div class="service-review">
                        <span class="rating"><?php echo $hotel["star_rating"]." ".$hotel["review_rating_desc"]; ?></span>
            <span class="st-dot"></span>
            <span class="review"><?php echo $hotel["review_rating"]; ?> Reviews</span>
        </div>
    ...
    <g id="Hotel-layout" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Log-In" transform="translate(-656.000000, -560.000000)">
            <g id="login" transform="translate(466.000000, 80.000000)">
                ...
                .st_1616163085{
                    background-image: url(https://dividivitravel.com/wp-content/uploads/2021/03/Chicago-scaled.jpg) !important;
                }
