...
<div>
     ...
     <div role="tabpanel" class="tab-pane " id="ss_flight"><div class="search-form hotel-search-form-home hotel-search-form in_tab" >
            ...
            <div class="col-lg-6 col-md-6">
              <div class="row">
               <div class="col-lg-6 col-md-6" style="margin-top: 2%; padding-left: 10%;">
               <input class="form-check-input" type="radio" name="radios" id="Round-trip" value="option1" checked="">
               <label class="form-check-label" for="exampleRadios1">
                Round-trip
               </label>
              </div> 
                <div class="col-lg-6 col-md-6" style="margin-top: 2%; padding-left: 6%; border-right: 1px solid #dfdfdf;">
...
</svg></i>                        <div class="form-group form-group-lg form-group-icon-left st_left">
    <label for="ss_location_origin">Origin</label>
    <div class="st-select-wrapper ss-flight-wrapper">
        <input required="" id="ss_location_origin" type="text" class="form-control ss-flight-location required" autocomplete="off" data-value="" data-name="ss_origin" value="" placeholder="Enter your origin" data-index="1">
    </div>
</div>                    </div>
                    <div class="col-lg-4 col-md-4 field-destination" style="border-right: 0px;">
                        <div class="form-group form-group-lg form-group-icon-left st_right" style="margin-left: -26px;">
    <label for="ss_location_destination">Destination</label>
    <div class="st-select-wrapper ss-flight-wrapper">
        <input required="" id="ss_location_destination" type="text" class="form-control ss-flight-location required" autocomplete="off" data-value="" data-name="ss_destination" value="" placeholder="Enter your destination" data-index="2">
    </div>
</div>                    </div>
...
<div data-tp-date-format="mm/dd/yyyy" class="form-group   form-group-lg form-group-icon-left st_left">
    <label for="field-depart-date">Depart</label>
    <input id="date_cal"  placeholder="mm/dd/yyyy" class="form-control required" readonly="" value="" type="text" style="text-align: center;">
...
<div data-tp-date-format="mm/dd/yyyy" class="form-group input-daterange input-daterange-return form-group-lg form-group-icon-left st_right">
    ...
    <input placeholder="mm/dd/yyyy" readonly="" class="form-control tp_return_date required" value="" type="text" style="text-align: center;">
    ...
    <!--<span class="fa fa-question-circle tp-return-note">
        <span class="return-data-tooltip none">
                        ...
                        <input type="hidden" class="skyscanner-search-flights-data" data-api="_dR-ShOTX6w2SeEN" data-locale="en-US" data-currency="USD" data-country="US">
            <input type="hidden" name="apiKey" value="_dR-ShOTX6w2SeEN">
            <div class="col-lg-2 col-md-2 ss-button-submit">
                <div class="form-button">
                    <button class="btn btn-primary btn-search" id="bflight" type="submit" style="min-height: 60px; margin-top: 26%; width: 90%; margin-right: 8%;">SEARCH</button>
                </div>
            </div>
        </div>
  ...
  <?php foreach( $itinerary_data as $itinerary =>$prueba){      ?>        
   <div style="border: 2px solid #dfdfdf; padding: 10px; height: 170px; margin-top: 50px;">
       <div class="col-lg-3 col-md-3" style="text-align: center; padding-top: 10px;">
                      ...
                      if($lave4 == "slice_data"){   
                         foreach($alor4 as $lave9 =>$alor9){ 
                             foreach($alor9 as $lave10 =>$alor10){
                                   if($lave10=="airline"){?>  
          <img src="<?php echo $alor10["logo"]; ?>">
          <p><?php echo $alor10["name"]; ?></p>
       </div><?php }else if($lave10=="departure"){ ?>
       <div class="col-lg-6 col-md-6" style="padding-top: 50px; text-align: center; border-right: 1px solid #dfdfdf; height: 100%;">   
          ...
          <div class="col-lg-8 col-md-8" style="height: 3px; background-color: black; margin-top: 25px;">
       ...
       <div class="col-lg-3 col-md-3" style="text-align: center; padding-top: 20px; color: #5191FA;">
